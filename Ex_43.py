# -*- coding: utf-8 -*-
"""
Created on Wed Nov  9 09:55:51 2022

@author: Filipe Pacheco

Livro: Aprendendo Python

Exercício 43 - Básico de Análise e Deisgn Orientados a Objetos
    ...
    def enter(self):
        ...
        if action == "shoot!":
            ...
            print(dedent("""
                         ...
                         Lbhe zbure vf fb sng, jura fur fvgf nebhaq gur ubhfr,
    ...
    def enter(self):
        ...
        if action == "throw the bomb":
            print(dedent("""
                         ...
                         Gothon shoots you right in the back killing you. Aas
        ...
        elif action == "slowly peace the bomb":
            print(dedent("""
                         You point your blaster at the bomb under your arm and
                         the Gothons put their hands up and start to sweat.
                         You inch backward to the door, open it, and then
                         carefully place the bomb on the floor, pointing your
                         blaster at it. You then jmp back through the door,
    ...
    def enter(self):
        ...
        if int(guess) != good_pod:
            ...
            print(dedent("""
                         ...
                         bright star, takiing out the Gothon ship at the same
                         time. You won!
                         """))
            return 'finished'
